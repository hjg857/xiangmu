        ...
        <div class="scoring-rules">
          ...
          <ul>
            <li>
              ...
              包含A11教师数据意识与思维、A12教师数据知识与技能、A13教师数据评价与交流、A14教师数据应用于创新、A15教师数据伦理与隐私等5个观测点，基于教师问卷中的《数据素养自我评价量表》，由教师对各题项的认同程度综合计分。
            </li>
            <li>
              <strong>A2 学生数据素养</strong>：<br/>
              包含A21学生数据意识与思维、A22学生数据知识与技能、A23学生数据评价与交流、A24学生数据应用于创新、A25学生数据伦理与隐私等5个观测点，基于学生问卷中的《数据素养自我评价量表》，由学生对各题项的认同程度综合计分。
            </li>
          </ul>
          <p class="rule-note">
